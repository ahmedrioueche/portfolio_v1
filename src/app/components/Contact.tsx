          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded-lg px-6 py-4 text-white placeholder-gray-400 focus:outline-none focus:border-primary focus:ring-0"
              />
              <input
                type="text"
            ...
            <textarea
              ...
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-6 py-4 text-white placeholder-gray-400 h-36 focus:outline-none focus:border-primary focus:ring-0"
            />
            <button
              type="submit"
              className="w-full text-white border border-primary bg-primary py-3 px-6 rounded-lg relative group transition-colors duration-300 hover:bg-primary/90"
            >
