    ...
    },
    {
        ...
        imageDescPairs: [
          ...
          { 
            ...
            description: "New users can sign up using a simple form. The user data is stored in Supabase, utilizing Prisma for schema management and seamless database migrations." 
          },
          { 
            image: "/km/km_compete.png", 
            description: "Users can compete in real-time typing challenges with friends or other players, powered by Pusher for seamless real-time communication. Real time communication poses various challenges such as synchronization, race conditions and dead locks, which had to be overcame." 
          },
          { 
            image: "/km/km_search.png", 
            description: "The search functionality allows users to look up specific games or competitors using a custom search algorithm that ensures fast and accurate results." 
          },
          { 
            image: "/km/km_join.png", 
            description: "Users can create rooms to invite friends, or join friend's rooms, this funcionality is managed in the Postgres database." 
          },
          { 
            image: "/km/km_settings.png", 
            description: "Users can customize their preferences (such as language and typing mode), which are stored in Supabase with a one-to-one relationship to their user profiles for persistent settings across sessions." 
          }
        ],
        conclusion: "KeyMaster is a fun and productive typing game that improves efficiency and competitive spirit. Future improvements include adding Google Ads for monetization.",
