export const projects = [
  ...
  },
  {
    ...
    imageDescPairs: [
      ...
      { image: "/gm/gm_settings.png", description: "The app offer settings to change the username, reset password, or choose another language (English, french, and spanish). user's data is stored in a local Sqlite database." },
    ],
